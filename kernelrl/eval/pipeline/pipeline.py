...
Coordinates hack checking, compilation, and timing modules.
Handles truncation detection, code fallback logic, and result aggregation.
"""
    ...
    return {
        ...
        "summary": {
            ...
            "timing": {
                ...
                "median_ms": (timing_result.get("metrics") or {}).get("median_ms"),
                "p10_ms": (timing_result.get("metrics") or {}).get("p10_ms"),
                "p90_ms": (timing_result.get("metrics") or {}).get("p90_ms"),
                "min_ms": (timing_result.get("metrics") or {}).get("min_ms"),
                "max_ms": (timing_result.get("metrics") or {}).get("max_ms"),
                "std_ms": (timing_result.get("metrics") or {}).get("std_ms"),
                "cv": (timing_result.get("metrics") or {}).get("cv"),
                "success_rate": (timing_result.get("metrics") or {}).get("success_rate"),
                "mode": (timing_result.get("metrics") or {}).get("mode"),
                "device": (timing_result.get("metrics") or {}).get("device"),
                "warmup_calls": (timing_result.get("metrics") or {}).get("warmup_calls"),
                "graph_iters": (timing_result.get("metrics") or {}).get("graph_iters"),
                "num_replays": (timing_result.get("metrics") or {}).get("num_replays"),
                "total_calls_per_sample": (timing_result.get("metrics") or {}).get("total_calls_per_sample"),
                "eager_probe_ms": (timing_result.get("metrics") or {}).get("eager_probe_ms"),
                "suspicious": (timing_result.get("metrics") or {}).get("suspicious"),
                "generated_mean_ms": (timing_result.get("metrics") or {}).get("generated_mean_ms"),
                "generated_median_ms": (timing_result.get("metrics") or {}).get("generated_median_ms"),
                "generated_p10_ms": (timing_result.get("metrics") or {}).get("generated_p10_ms"),
                "generated_p90_ms": (timing_result.get("metrics") or {}).get("generated_p90_ms"),
                "generated_min_ms": (timing_result.get("metrics") or {}).get("generated_min_ms"),
                "generated_max_ms": (timing_result.get("metrics") or {}).get("generated_max_ms"),
                "generated_stdev_ms": (timing_result.get("metrics") or {}).get("generated_stdev_ms"),
                "generated_cv": (timing_result.get("metrics") or {}).get("generated_cv"),
                "generated_warmup_calls": (timing_result.get("metrics") or {}).get("generated_warmup_calls"),
                "generated_total_calls_per_sample": (timing_result.get("metrics") or {}).get("generated_total_calls_per_sample"),
                "generated_graph_iters": (timing_result.get("metrics") or {}).get("generated_graph_iters"),
                "generated_num_replays": (timing_result.get("metrics") or {}).get("generated_num_replays"),
                "generated_eager_probe_ms": (timing_result.get("metrics") or {}).get("generated_eager_probe_ms"),
                "generated_suspicious": (timing_result.get("metrics") or {}).get("generated_suspicious"),
                "reference_mean_ms": (timing_result.get("metrics") or {}).get("reference_mean_ms"),
                "reference_median_ms": (timing_result.get("metrics") or {}).get("reference_median_ms"),
                "reference_p10_ms": (timing_result.get("metrics") or {}).get("reference_p10_ms"),
                "reference_p90_ms": (timing_result.get("metrics") or {}).get("reference_p90_ms"),
                "reference_min_ms": (timing_result.get("metrics") or {}).get("reference_min_ms"),
                "reference_max_ms": (timing_result.get("metrics") or {}).get("reference_max_ms"),
                "reference_stdev_ms": (timing_result.get("metrics") or {}).get("reference_stdev_ms"),
                "reference_cv": (timing_result.get("metrics") or {}).get("reference_cv"),
                "reference_warmup_calls": (timing_result.get("metrics") or {}).get("reference_warmup_calls"),
                "reference_total_calls_per_sample": (timing_result.get("metrics") or {}).get("reference_total_calls_per_sample"),
                "reference_graph_iters": (timing_result.get("metrics") or {}).get("reference_graph_iters"),
                "reference_num_replays": (timing_result.get("metrics") or {}).get("reference_num_replays"),
                "reference_eager_probe_ms": (timing_result.get("metrics") or {}).get("reference_eager_probe_ms"),
                "reference_suspicious": (timing_result.get("metrics") or {}).get("reference_suspicious"),
            ...
            "hack_check": {
                "has_issue": (hack_result.get("metrics") or {}).get("has_issue"),
                "issue_total": (hack_result.get("metrics") or {}).get("issue_total"),
